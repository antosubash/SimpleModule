...
public class ModuleExtensionsGenerationTests
{
    ...
    public void ModuleWithOnlyConfigureServices_SkipsEndpointCall()
    {
        ...
        moduleExt
            .Should()
            .Contain(
                "((global::SimpleModule.Core.IModule)s_TestApp_ServiceOnlyModule).ConfigureServices(services, configuration)"
            );
    ...
    public void MultipleModules_EachGetsOwnSharedInstance()
    {
        ...
        moduleExt
            .Should()
            .Contain(
                "((global::SimpleModule.Core.IModule)s_TestApp_AlphaModule).ConfigureServices"
            );
        ...
        endpointExt
            .Should()
            .Contain(
                "((global::SimpleModule.Core.IModule)ModuleExtensions.s_TestApp_BetaModule).ConfigureEndpoints"
            );
