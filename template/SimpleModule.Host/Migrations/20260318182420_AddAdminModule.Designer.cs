...
namespace SimpleModule.Host.Migrations
{
    ...
    [Migration("20260318182420_AddAdminModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleModule.Admin.Entities.AuditLogEntry", b =>
                {
                    ...
                    b.ToTable("AuditLogEntries", "admin");
                });
            ...
            modelBuilder.Entity("SimpleModule.Users.Entities.RolePermission", b =>
                {
                    b.Property<string>("RoleId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SimpleModule.Users.Entities.UserPermission", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SimpleModule.Users.Entities.RolePermission", b =>
                {
                    b.HasOne("SimpleModule.Users.Entities.ApplicationRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SimpleModule.Users.Entities.UserPermission", b =>
                {
                    b.HasOne("SimpleModule.Users.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
